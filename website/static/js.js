...
{const shapes1 = [
    ...
    DOM1.contentElems = Array.from(document.querySelectorAll('.morph-marker'));
    DOM1.footer = document.querySelector('.last-morph');

    const contentElemsTotal = DOM1.contentElems.length;

    const DOM2 = {};
DOM2.svg = document.querySelector('#morph2');
DOM2.shapeEl = DOM2.svg.querySelector('path');
DOM2.contentElems = Array.from(document.querySelectorAll('.morph-marker'));
DOM2.footer = document.querySelector('.last-morph');
...
const createScrollWatchers = function(shapes, DOM) {
        <!--loop over the elements get element and position -->
        DOM.contentElems.forEach((el,pos) => {
            const scrollElemToWatch = pos ? DOM.contentElems[pos] : DOM.footer;
            pos = pos ? pos : contentElemsTotal;
                <!--This will trigger events when element is 300px in the viewport-->
...
const init = function() {
    imagesLoaded(document.body, () => {
        ...
        initShapeEl(shapes2, DOM2);
        createScrollWatchers(shapes2, DOM2);
        initShapeEl(shapes1, DOM1);
        createScrollWatchers(shapes1, DOM1);
    });};
